    ...
    <div className="min-h-screen flex bg-[#1a1a1a] text-white font-inter transition-all duration-300">
      ...
      <main className={`flex-1 flex flex-col sm:ml-56 ml-0 transition-all duration-300 ${(activeNav === 'menu' && showShoppingCart) ? 'menu-with-cart' : ''}`} style={mainContentStyle}>
        <div className="max-w-3xl md:max-w-5xl lg:max-w-6xl xl:max-w-7xl w-full py-10 px-4 mx-auto main-content">
                    ...
                    <div className="bg-[#2a2a2a] rounded-[12px] border border-[#3a3a3a] overflow-hidden">
                      <div className="overflow-x-auto">
                        <table className="w-full text-sm">
                          ...
                          <tbody>
                            {(() => {
                              // Sort cart by category: Appetizer → Nigiri → Maki Rolls → Speciality Rolls
                              const categoryOrder = {
                                'Appetizer': 1,
                                'Nigiri': 2,
                                'Maki Rolls': 3,
                              ...
                              const sortedCart = [...cart].sort((a, b) => {
                                const aData = typeof a === 'object' && a !== null ? a : null;
                                const bData = typeof b === 'object' && b !== null ? b : null;
                                if (!aData || !bData) return 0;
                                
                                const aOrder = categoryOrder[aData.category] || 999;
                                const bOrder = categoryOrder[bData.category] || 999;
          ...
          {/* Cart Page - shows current cart items in table format */}
          {activeNav === 'cart' && !currentEventId && (
            <section id="cart" className="w-full py-10 px-4">
              <div className="w-full max-w-6xl lg:max-w-7xl xl:max-w-[1600px] mx-auto">
                ...
                {cart.length === 0 ? (
                  <div className="text-center py-12 bg-[#2a2a2a] rounded-[12px] border border-[#3a3a3a]">
                    ...
                    <div className="text-[#b0b8c1] text-sm">Add items to your cart from the Menu page</div>
                  </div>
                ) : (
                  <div className="bg-[#2a2a2a] rounded-[12px] border border-[#3a3a3a] overflow-hidden">
                    <div className="overflow-x-auto">
          ...
          <div className="flex-1 overflow-y-auto">
            ...
            <div className="bg-[#1a1a1a] rounded-[12px] p-4 mb-4">
              <div className="flex justify-between items-start mb-3">
                ...
                <span className="bg-[#3a3a3a] px-2 py-1 rounded text-sm text-[#b0b8c1] ml-2">
